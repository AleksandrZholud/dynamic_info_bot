...
public class BotApplication {
    ...
    private static final String USERS_COLLECTION = "users"; //do we need this?
    ...
    public static void main(String[] args) {
        ...
        MongoDatabase database = mongoClient.getDatabase("telegram_bot");
        UserRepository userRepository = new UserRepository(database); //we need more repos for TG-bot (history, buttons, ect.)
